...
|---|---|---|
| 2026-09-12 | TBD | Builder v2: click-drag to draw any size, multi-select (Shift+click), group drag-move, Ctrl+C/Ctrl+V chain paste with directional repeat (E/S/W/N), WASD disabled while typing in input fields |
