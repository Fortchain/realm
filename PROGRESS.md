...
|---|---|---|
| 2026-09-12 | next | Isometric city rewrite: 2.5D GTA-style projection, 20×20 tile grid, painter's algo depth ordering, diagonal (W=up/S=down/A=left/D=right) movement, isometric cubes for all buildings (generic + named), park trees, road dashes, beach/water tiles, manual slide collision, MapHUD converted to top-down minimap with iso↔tile coordinate bridge |
